...
Original file is located at
    https://colab.research.google.com/drive/1X9JSMLomtycQI7WPr1JlPBT4KMUEPUyh
"""
...
def get_shares(tweets_df,capital,bl1=False,long_only=False):
  recent_df=tweets_df[tweets_df['dates']==tweet_df['dates'].unique()[-1]]
