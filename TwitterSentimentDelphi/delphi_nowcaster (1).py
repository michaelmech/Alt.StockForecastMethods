...
Original file is located at
    https://colab.research.google.com/drive/1ss96iOUJmxmRI-SkwDbDfjTMKYyU_ivY
"""
...
key= '6bjiljQWxEt3GpISucXFPuuUJ'

secret= '8zCwY6f9vrWV9hAxj29IpLfXStVbp4by8U238xx6R2j5RU4ER3'
...
def get_tweets(accounts_list):
  ...
  try:
    ...
    for id in accounts_list:
      ...
      for status in Cursor(api.user_timeline, id=id,tweet_mode='extended').items():
